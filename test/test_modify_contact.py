...
def test_edit_some_contact(app):
    ...
    contact_name.id = old_contacts[index].id
    app.contact.edit_contact_by_index(index, Contact(first_name=contact_name.first_name, middle_name="1Hgf",
    ...
    old_contacts[index] = contact_name
